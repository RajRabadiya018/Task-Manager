        ...
        <div className="mx-auto max-w-2xl space-y-6">
            ...
            <div className="rounded-xl border border-border bg-card p-6">
                ...
                <div className="grid grid-cols-2 gap-4 rounded-lg border border-border bg-background p-4">
                    <div>
                        <span className="text-[11px] font-medium uppercase tracking-wider text-muted-foreground">Due Date</span>
                        <p className={`mt-1 text-sm font-medium ${isOverdue ? "text-red-400" : "text-foreground"}`}>
                            {formatDate(task.dueDate)}
                        </p>
                    </div>
                    <div>
                        <span className="text-[11px] font-medium uppercase tracking-wider text-muted-foreground">Created</span>
                        <p className="mt-1 text-sm font-medium text-foreground">{formatDate(task.createdAt)}</p>
                    </div>
                    <div>
                        <span className="text-[11px] font-medium uppercase tracking-wider text-muted-foreground">Assigned To</span>
                        <p className="mt-1 text-sm font-medium text-foreground">{task.assignedTo || "Unassigned"}</p>
                    </div>
                    <div>
